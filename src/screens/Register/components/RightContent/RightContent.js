    ...
    return (
      <div className="rightPanel">
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="email" value={email} name="email" onChange={(e) => { this.inputChange(e)} } className="form-control" id="email" placeholder="Enter Your Mail Id" />
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <input type="text" pattern="[0-9]" maxLength="14" value={telephone} name="telephone" onChange={(e) => { this.inputChange(e)} }  className="form-control" id="telephone" placeholder=" Enter your phone number" />
        ...
        <div class="col-sm-2 col-form-label">
                ...
                <div class="col-">
                    <input type="Date" id="dob" name="dob" required="" autofocus=""class="form-control"/>
                </div>
          </div>
        <div className="row">
        ...
        <div className="row">
          <label htmlFor="staticEmail1" className="col-sm-2 col-form-label">Languages</label>
          <div className="col-sm-6 mb-2">
            <MultiSelect className="form-control" searchPlaceholder="Languages Known" selected={interests} onSelect={this.onSelectedInterest} />
            { submitted && this.state.errors.user.interests.length > 0 &&  <span className='error'>{this.state.errors.user.interests}</span>}
          </div>
          <div className="col-sm-4">
          </div>
        ...
        <div className="row">
          ...
          <div className="col-sm-6 mb-2">
            <label htmlFor="subscribenewsletter"><input type="checkbox" checked={subscribenewsletter} name="subscribenewsletter" onChange={this.checkboxChange} id="subscribenewsletter" style={{margin: '10px'}} />I agree metrolabs Terms and Conditions</label>
          </div>
          <div className="col-sm-4">
          </div>
        </div>
